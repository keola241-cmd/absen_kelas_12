...
GOOGLE_SHEET_URL = 'https://script.google.com/macros/s/AKfycbxMkejmApIlGoks7dCx0vxA03Ge17qZETpDXOJwCEZSCJUIAppkUIYM70iM24WTJ46sqA/exec'
...
def proses_absen():
    ...
    # --- ATURAN JAM MASUK ---
    BATAS_JAM_MASUK = "16:00" # <-- Ganti di sini kalau jam masuknya beda
